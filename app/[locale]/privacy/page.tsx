...
export default function PrivacyPage() {
  ...
  const sections = [
    { key: 'section1', icon: FileText },
    { key: 'section2', icon: Eye },
    { key: 'section3', icon: Globe },
    { key: 'section4', icon: Server },
    { key: 'section5', icon: Lock },
    { key: 'section6', icon: Shield },
  ];
          ...
          <div className="grid gap-6">
            {sections.map(({ key, icon: Icon }) => (
              <motion.section
                ...
                className="group relative overflow-hidden bg-white/5 hover:bg-white/10 border border-white/5 hover:border-primary/20 rounded-2xl p-8 transition-all duration-300"
              >
